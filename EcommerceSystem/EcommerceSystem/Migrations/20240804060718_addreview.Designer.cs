...
namespace OnlineBookOrderingSystem.Migrations
{
    ...
    [Migration("20240804060718_addreview")]
            ...
            modelBuilder.Entity("RepositoryLayer.Entity.Notification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CustomerId = 1,
                            Date = new DateTime(2024, 8, 4, 6, 7, 17, 445, DateTimeKind.Utc).AddTicks(1873),
                            IsRead = false,
                        ...
                        new
                        {
                            Id = 2,
                            CustomerId = 2,
                            Date = new DateTime(2024, 8, 4, 6, 7, 17, 445, DateTimeKind.Utc).AddTicks(1876),
                            IsRead = false,
            ...
            modelBuilder.Entity("RepositoryLayer.Entity.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CustomerId = 1,
                            OrderDate = new DateTime(2024, 8, 4, 6, 7, 17, 445, DateTimeKind.Utc).AddTicks(1613)
                        },
                        new
                        {
                            Id = 2,
                            CustomerId = 2,
                            OrderDate = new DateTime(2024, 8, 4, 6, 7, 17, 445, DateTimeKind.Utc).AddTicks(1617)
                        },
                        new
                        {
                            Id = 3,
                            CustomerId = 3,
                            OrderDate = new DateTime(2024, 8, 4, 6, 7, 17, 445, DateTimeKind.Utc).AddTicks(1620)
                        },
                        new
                        {
                            Id = 4,
                            CustomerId = 4,
                            OrderDate = new DateTime(2024, 8, 4, 6, 7, 17, 445, DateTimeKind.Utc).AddTicks(1621)
                        },
                        new
                        {
                            Id = 5,
                            CustomerId = 5,
                            OrderDate = new DateTime(2024, 8, 4, 6, 7, 17, 445, DateTimeKind.Utc).AddTicks(1623)
                        });
                });
